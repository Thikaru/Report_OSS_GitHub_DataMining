...
# 変数選択を行い，残したい変数を二値化する処理を行うプログラム

# 読み込みCSV：データクリーニングをするCSV
DataCleaning_CSV = "AllCSV/FakedataMonden_utf8_test_data.csv"
# 書き込みCSV：データをクリーニングしたCSV
WriteFile_CSV = "LastCSV/cleaning_data_test_-1.csv"

# どのカラムに対して処理を行うかどうか
# 行うカラムは，data_histgramなどで分析した結果を選択
is_development_type = False
is_industry_type = True
is_architect_type = False
...
header = "ID,year,lang:Java,lang:ASP,ind-type:manufacture,FP,range-dev,month,man-month\n"
body_record = ""
